...
// Database connection string for Vercel serverless - properly encode password
const dbPassword = process.env.SUPABASE_DB_PASSWORD || 'E$rNc9z?Wtpgq&%'
const encodedPassword = encodeURIComponent(dbPassword)
const connectionString = `postgresql://postgres.qalxoheykkdfqsakvcad:${encodedPassword}@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres`
